...
import blogsData from "@/app/_sections/blogs.json";
...
function BlogDetails({ params }) {
  ...
  const title = slug ? slug.replace(/-/g, " ") : "Blog Details";

  // Find current post
  const currentPost = blogsData.posts.find((p) => p.link.split("/").pop() === slug) || blogsData.posts[0];

  // Dynamic Navigation
  const currentIndex = blogsData.posts.findIndex((p) => p.link.split("/").pop() === slug);
  const prevPost = currentIndex > 0 ? blogsData.posts[currentIndex - 1] : null;
  const nextPost = currentIndex < blogsData.posts.length - 1 ? blogsData.posts[currentIndex + 1] : null;
              ...
              <div className="flex flex-col gap-y-10 lg:gap-y-14 xl:gap-y-20">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <article className="jos overflow-hidden bg-white">
                    ...
                    <ul className="flex flex-wrap items-center gap-6">
                      <li className="relative font-semibold after:absolute after:left-full after:top-1/2 after:h-[7px] after:w-[7px] after:-translate-y-1/2 after:translate-x-2 after:rounded-full after:bg-colorCodGray last:after:hidden">
                        <Link href={currentPost.link} className="hover:text-colorOrangyRed">
                    ...
                    {/* Blog Post Meta */}
                    <h5 className="mb-3 mt-5">{currentPost.title}: unlock exponential growth</h5>
                    <p className="mb-7 last:mb-0">
                      {currentPost.description} The rapid advancements in AI have paved the way for
                      startups to revolutionize their businesses. This article explores key ways AI
                      can be integrated into startups and provides real-world examples of its
                    ...
                    <ul className="mb-7 flex flex-col gap-7 last:mb-0">
                      <li>
                        ...
                        <p className="mb-7 last:mb-0">
                          AI chatbots and virtual assistants can handle routine queries, troubleshoot
                          issues, and guide users, improving response times. This frees up human
                          agents to tackle complex tasks, enhancing user experience.
                        </p>
                      </li>
                      <li>
                        <div className="font-semibold">2. Predictive Maintenance</div>
                        <p className="mb-7 last:mb-0">
                          By analyzing usage patterns, ML algorithms can predict failures, enabling
                      ...
                      <li>
                        ...
                        <p className="mb-7 last:mb-0">
                          AI anomaly detection, behavior analysis, and intrusion prevention boost
                          security and data protection. This safeguards infrastructure and builds user
                          trust.
                        </p>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <p className="mb-7 last:mb-0">
                          By analyzing behavior and preferences, AI tailors interfaces and features.
                          This improves satisfaction and encourages retention.
                        </p>
                      </li>
                      <li>
                        <div className="font-semibold">5. Automated Workflows</div>
                        <p className="mb-7 last:mb-0">
                          Automating tasks like software updates and license management with AI reduces
                          manual efforts and minimizes errors.
                        </p>
                      </li>
                    </ul>
                    ...
                    <p className="mb-7 last:mb-0">
                      The key to startup success is focusing AI efforts on the applications that will
                      differentiate your business and have the biggest impact at each stage of
                      growth. With the right strategy, AI can unlock transformation opportunities and
                  ...
                  <div className="jos flex flex-col justify-between md:flex-row md:gap-x-10 xl:gap-x-24 xxl:gap-x-[196px]">
                    {prevPost ? (
                      <Link href={prevPost.link} className="group text-left">
                    ...
                    {nextPost ? (
                      <Link href={nextPost.link} className="group text-right">
                        ...
                        <div className="flex gap-x-5">
                          ...
                          <div className="flex flex-1 flex-col gap-y-4">
                            ...
                            <p className="max-w-[616px]">
                              It is a long established fact that a reader will be distrac readable
                              content of a page when looking at its layout. The point of using is
                              that it has two.
                            </p>
                            {/* Comment User Text */}
                          </div>
                            ...
                            <div className="flex gap-x-5">
                              ...
                              <div className="flex flex-1 flex-col gap-y-4">
                                ...
                                <p className="max-w-[536px]">
                                  It is a long established fact that a reader will be distra readable
                                  content of a page when looking its layout. The point of using.
                                </p>
                                {/* Comment User Text */}
                              </div>
                              {/* Comment Content */}
                    ...
                    <form action="#" method="post" className="flex flex-col gap-y-5">
                      ...
                      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
                        ...
                        <div className="flex flex-col gap-y-[10px]">
                          <label htmlFor="comment-name" className="text-lg font-bold leading-[1.6]">
                            Enter your name
                          </label>
                          <input
                            type="text"
                        ...
                        {/* Form Single Input */}
                        <div className="flex flex-col gap-y-[10px]">
                          <label htmlFor="comment-email" className="text-lg font-bold leading-[1.6]">
                            Email address
                          </label>
                          <input
                            type="email"
                      ...
                      <div className="grid grid-cols-1 gap-6">
                        {/* Form Single Input */}
                        <div className="flex flex-col gap-y-[10px]">
                          <label htmlFor="comment-message" className="text-lg font-bold leading-[1.6]">
                            Message
                          </label>
                          <textarea
