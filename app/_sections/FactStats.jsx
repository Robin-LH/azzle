      ...
      <div className="global-container">
        <ul className="grid grid-cols-1 gap-10 gap-y-5 text-center sm:grid-cols-2 sm:text-left lg:grid-cols-4">
          <li className="jos" data-jos_delay="0.1">
            ...
            <span className="block text-lg font-normal text-black">Successful Implementations</span>
          </li>
          <li className="jos" data-jos_delay="0.2">
            ...
            <span className="block text-lg font-normal text-black">Client Satisfaction Rate</span>
          </li>
          <li className="jos" data-jos_delay="0.3">
            ...
            <span className="block text-lg font-normal text-black">Awards and Recognitions</span>
          </li>
          <li className="jos" data-jos_delay="0.4">
            ...
            <span className="block text-lg font-normal text-black">Growth and Expansion</span>
          </li>
        </ul>
      </div>
    </section>
